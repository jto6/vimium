...
const defaultKeyMappings = {
  ...
  "<m-v>": "scrollPageUp",
  "<m-r>": "reload",
  "<c-g><c-u>": "copyCurrentUrl",
  "<c-g><c-o>": "openCopiedUrlInCurrentTab",
  "<c-g><c-O>": "openCopiedUrlInNewTab",
  "<c-g><c-f>": "focusInput",
  "<c-g><left>": "goPrevious",
  "<c-g><right>": "goNext",
  "<c-x>o": "nextFrame",
  ...
  // Link hints
  "<c-x><c-f>": "LinkHints.activateMode",
  "<c-x><a-F>": "LinkHints.activateModeToOpenInNewTab",
  "<c-x><a-f>": "LinkHints.activateModeWithQueue",
  "<c-g><c-l>": "LinkHints.activateModeToCopyLinkUrl",
  ...
  // Vomnibar
  "<c-x><c-d>": "Vomnibar.activate",
  "<c-x><c-D>": "Vomnibar.activateInNewTab",
  "<c-x>b": "Vomnibar.activateTabSelection",
  "<c-x><c-b>": "Vomnibar.activateBookmarks",
  "<c-x><c-B>": "Vomnibar.activateBookmarksInNewTab",
  "<c-x>e": "Vomnibar.activateEditUrl",
  "<c-x>E": "Vomnibar.activateEditUrlInNewTab",
  ...
  // Marks
  "<c-@>": "Marks.activateCreateMode",
  "<c-x><c-@>": "Marks.activateGotoMode",

  // Misc
  "<c-h>": "showHelp",
  "<a-s>": "toggleViewSource",
};
